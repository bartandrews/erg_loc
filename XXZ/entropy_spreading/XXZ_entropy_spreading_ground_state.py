...
ax0 = plt.subplot(111)
ax0.set_title(f"$H=\sum_i \sigma^x_{{i}} \sigma^x_{{i+1}} +\sigma^y_i \sigma^y_{{i+1}} + J \sum_i \sigma^z_i \sigma^z_{{i+1}} + \sum_i h_i \sigma^z_i$ with $h_i\in[-W,W]$, $J={J_z_0}$, $L={L}$ (ground state, {numb_itr} disorders)")
...
plt.savefig(f"/home/bart/Documents/papers/MBF/XXZ/entropy_spreading/XXZ_entropy_spreading_ground_state_J_{J_z_0}.png", bbox_inches='tight', dpi=300)
plt.show()
