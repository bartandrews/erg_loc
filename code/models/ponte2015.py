...
def ponte2015(L, Nup, pauli, J_x, J_y, J_z, W, h_0=2, T_0=7, T_1=1.5):
    ...
    h_term = [[h_0, L//2]]
    static = []
    dynamic = [["xx", J_x_term, _H0_drive, drive_args],
               ["yy", J_y_term, _H0_drive, drive_args],
               ["zz", J_z_term, _H0_drive, drive_args],
               ["z", h_z_term, _H0_drive, drive_args],
